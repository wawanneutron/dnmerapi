        ...
        <div class="row ml-1">
          <div class="col p-0">
            <nav>
              ...
              <li class="breadcrumb-item"> <a href="{{ route('details',[$item->travel_package->slug, $item->travel_package->id]) }}">Details</a></li>
              ...
              <div class="col-lg-4">
                  ...
                  @if ($cek_member > $cek_kuota)
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('details', [$item->travel_package->slug, $item->travel_package->id]) }}" class="text-muted mt-3 py-2">Batalkan
                            Pembayaran</a>
                    </div>
                  @elseif ($cek_kuota == 0)
                     <!-- CTE -->
                  ...
                  @else
                    <!-- CTE -->
                    <div class="join-container">
                        <a href="{{ route('checkout-succses', $item->id) }}" class="btn btn-block btn-join-now mt-3 py-2">Proceed to payment</a>
                    </div>
                    <div class="text-center mt-3">
                        <a href="{{ route('details', [$item->travel_package->slug, $item->travel_package->id]) }}" class="text-muted mt-3 py-2">Cancle Payment</a>
                    </div>
                  @endif
              </div>
          </div>
